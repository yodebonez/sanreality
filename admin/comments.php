		...
		<div id="sideNav" href=""><i class="fa fa-caret-right"></i></div>
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="comments.php"><i class="fa fa-fw fa-file"></i>View Comment</a>
                    </li>
            ...
            <div id="page-inner">
              ...
              //  $conn = mysqli_connect("localhost","mcbuddye_cteam","^W@(aGb#?;qP","mcbuddye_codeteam");
                    ...
                    if (mysqli_num_rows($result) > 0) {
						...
						<td><?php 	$csql = "SELECT title FROM content WHERE id={$row['cid']}";
						...
						<td><?php if(isset($row['status']) & !empty($row['status'])){echo $row['status'];}else{echo "NA";} ?></td> 
						<td><a href="editcomment.php?id=<?php echo $row['id']; ?>">Edit</a> <a href="commentstatus.php?id=<?php echo $row['id']; ?>&status=publish">App</a> <a href="commentstatus.php?id=<?php echo $row['id']; ?>&status=draft">Dis</a> <a href="delcomment.php?id=<?php echo $row['id']; ?>">Del</a></td> 
