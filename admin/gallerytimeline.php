...
if(isset($_POST['videosubmit'])){
    ...
    for($i = 0; $i < $filecount; $i++){
        ...
        $sql = "INSERT INTO gallerytimeline (name) VALUES ('$video')";
    ...
    if($res){
        ...
        // $videotemp = $_FILES['video']['tmp_name'];
         ...
         move_uploaded_file($_FILES['video']['tmp_name'][$i], "Timeline/$video");
        ...
        <div id="page-wrapper" >
		  <div class="header"> 
                        <h1 class="page-header">
                            Timeline Videos/Images <small></small>
                        </h1>
					<!--	<ol class="breadcrumb">
					  <li><a href="#">Home</a></li>
            ...
            <div id="page-inner"> 
                                    ...
                                    <form role="form" method="post" action="#" enctype="multipart/form-data">
                                     ...
                                     <!--
                                       <div class="form-group">
                                         ...
                                         -->
                                        <div class="form-group">
                                            <label>Multiple videos/Images</label>
              ...
              //  $conn = mysqli_connect("localhost","mcbuddye_cteam","^W@(aGb#?;qP","mcbuddye_codeteam");
                    ...
                    $sql = "SELECT * FROM gallerytimeline";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while($row = mysqli_fetch_assoc($result)) {
                          ...
                          <a href="https://www.w3schools.com"><td><?php echo $row["id"]   ?></td>  </a>          
                                ...
                                <td> <a href="gallerytimelinestatus.php?id=<?php echo $row['id']; ?>&status=publish">Pub</a> <a href="gallerytimelinestatus.php?id=<?php echo $row['id']; ?>&status=draft">Dis</a> <a href="delgallerytimeline.php?id=<?php echo $row['id']; ?>">Del</a></td> 
