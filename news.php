...
<head>
    ...
    <title>Super Affiliate Nigeria : Blog &mdash; </title>
            ...
            <div class="panel panel-default" style="border: 2px solid rgba(129, 129, 129, 0.067); background: linear-gradient(to top, #2D2E33 30%, #2D2E33 70%, #2D2E33 100%);">
              <div class="panel-body blogh2" >
                <p class="p-2"><strong><a href="single.php?url=<?php echo $r['url']; ?>"><h2><?php echo $r['title']; ?></strong></p>
                  <div class="row">
                      <div class="col-md-3 blogimg"><img src="admin/<?php echo $r['featuredimage']; ?>" height="600px" width="600px" class="img-circle img-responsive mb-4"> </div>
                      <div class="col-md-9">
                          <p><?php
                                ...
                                if (strlen($string) > 5) {
                                  ...
                                  //  $string .= ' <a class="btn btn-primary pull-right" href="singlenews.php?url= '. ' $r['url'];'. '" role="button">Read More</a>';
                                }
                                ?>
                                 <a class="btn btn-primary pull-right" href="singlenews.php?url=<?php echo $r['url']; ?>" role="button">Read More</a>
                                <?php
                                echo $string;
