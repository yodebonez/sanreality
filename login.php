...
if (isset($_POST["email"]) && isset($_POST["password"])) {
   ...
   // include "functions.php";
    $sql = mysqli_query($connection,"SELECT * FROM generaluser WHERE username='$manager' AND password='$password' LIMIT 1");
         ...
         <div class="main-login main-center" style=" background: linear-gradient(to top, #2D2E33 30%, #2D2E33 70%, #2D2E33 100%);">
            ...
            <form class="form-horizontal" method="post" action="login.php">
                ...
                <div class="form-group pt-3">
                    ...
                    <input type="submit" name="submit" style="background-color: #c11021; color:#fff; font-weight: 700;" class="btn   btn-block login-button" value="Login"/> 
                </div>
            </form>
            <p class="text-center">Don't have an account? <span><a href="register.php">Register</a></span></p>
               <p class="text-center">Forget password? <span><a href="resetpassword.php">Password Reset</a></span></p>
        </div>
      </div>
    </div>
  </div>
